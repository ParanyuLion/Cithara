    ...
    >
      ...
      >
        ...
        <circle
          ...
          cy="80"
          r="28"
          fill="rgba(29,185,84,0.07)"
          stroke="rgba(29,185,84,0.2)"
          strokeWidth="1.5"
        />
        {/* musical note */}
        <path
          d="M76 68v18M76 68l12-4v18"
          stroke="var(--accent)"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        {/* waveform left */}
        <path
          d="M18 80 Q25 68 32 80 Q39 92 46 80"
        ...
        {/* waveform right */}
        <path
          d="M114 80 Q121 68 128 80 Q135 92 142 80"
          stroke="rgba(29,185,84,0.35)"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
      ...
      >
        No songs yet. Let AI compose your first track — just describe what you
        have in mind.
      </p>
      <a
        href="/new/"
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = "0 6px 24px rgba(29,185,84,0.45)";
        }}
        onMouseLeave={(e) => {
  ...
  return (
    <div
      style={{
        ...
        right: 0,
        background:
          "linear-gradient(180deg, rgba(20,20,20,0.97) 0%, #111 100%)",
        ...
        <div
          style={{
            ...
            background: song.cover_image_url
              ? "none"
              : "linear-gradient(135deg,#1DB954 0%,#0d7a3a 100%)",
            overflow: "hidden",
...
function SongList() {
  ...
  const filtered = React.useMemo(() => {
    ...
    return songs.filter((s) => {
      const matchesQuery =
        !q ||
        [s.title, s.genre, s.mood, s.ocasion, s.singer_voice].some(
  ...
  function openDeleteConfirm(song) {
    if (!deleting) setDeleteTarget(song);
  }
  ...
  function handleNext() {
    ...
    const idx = nowPlaying
      ? playable.findIndex((s) => s.id === nowPlaying.id)
      : -1;
          ...
          >
            ...
            <div style={{ position: "relative", flexShrink: 0 }}>
              <button
                ...
                title="Filter"
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = hasActiveFilter
                    ? "var(--accent)"
                    : "rgba(255,255,255,0.2)";
                  e.currentTarget.style.color = hasActiveFilter
                    ? "var(--accent)"
                    : "var(--text)";
                }}
                onMouseLeave={(e) => {
                  ...
                  >
                    {allStatuses.map((s) => (
                      <button
                        ...
                        style={chipStyle(activeFilters.status === s)}
                      >
                        {s}
                      </button>
                    ))}
        ...
        {!loading && !error && songs.length > 0 && filtered.length === 0 && (
          ...
          >
            ...
            <p style={{ fontSize: "14px" }}>
              No songs match "
              {query || Object.values(activeFilters).filter(Boolean).join(", ")}
              "
            </p>
          </div>
        )}
        ...
        {deleteTarget && (
          ...
          >
            ...
            >
              ...
              >
                This action cannot be undone. "{deleteTarget.title}" will be
